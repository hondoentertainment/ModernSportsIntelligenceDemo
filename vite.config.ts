  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        'lib/utils/alertPreferences.ts',
        'lib/utils/showBag.ts',
        'lib/utils/centeringHeuristic.ts',
        'lib/analytics/performanceVsPrice.ts',
        'lib/analytics/gradingRoiLite.ts',
        'lib/trading/autoPilotImpactPreview.ts',
        'lib/trading/autoPilotReplay.ts',
        'lib/analytics/portfolioConcentration.ts',
        'lib/analytics/capitalGainsExit.ts',
        'lib/utils/syncProductDefaults.ts',
        'lib/utils/webPushSubscription.ts',
        'lib/utils/migrationFieldDiff.ts',
        'lib/utils/offlineSyncStatus.ts',
        'lib/analytics/holdingHorizon.ts',
        'lib/analytics/ratioIntelligence.ts',
        'lib/analytics/portfolioMovers.ts',
        'lib/analytics/dealFinderLite.ts',
        ...
        'lib/pricing/freshnessSla.ts',
        'lib/push/vapidEnv.ts',
        'lib/integrations/mlbLiveWire.ts',
        'lib/trading/p2pMatchingEngine.ts',
        'lib/trading/executionAdapterStub.ts',
        'lib/integrations/showFloorPartner.ts',
        'lib/platform/apiLicenseModel.ts',
        'lib/platform/webhookEvents.ts',
        'lib/platform/webhookDispatcher.ts',
        'lib/htmlEscape.ts',
      ],
