...
| P1 — punch-list items 1/3/4             | ✅ Checked off in `docs/LAUNCH_OPS_PUNCH_LIST.md` with evidence (green scheduled workflows through 2026-07-03).                                                                                                                                                                                                                 |
