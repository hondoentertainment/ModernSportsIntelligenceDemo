...
import { Brain, RefreshCw, Send, ShieldCheck, Target, TrendingUp, Info, Activity } from 'lucide-react';
                                        ...
                                        <div className="bg-brand-charcoal rounded-[14px] p-6 flex flex-col md:flex-row items-center justify-between gap-4">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <h3 className="text-xl font-bold text-white">{thesis?.recommendedAction}</h3>
                                                </div>
                                            </div>
                                            <button className="whitespace-nowrap bg-brand-lime text-brand-charcoal font-black py-3 px-6 rounded-xl hover:scale-105 transition-transform">
                                                EXECUTE STRATEGY
                                            </button>
                                        </div>
                                    </div>
