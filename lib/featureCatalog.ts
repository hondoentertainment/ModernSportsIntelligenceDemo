...
/**
 * Feature Catalog — master registry of all 103 platform features
...
export const FEATURE_CATALOG: Feature[] = [
  ...
  { id: 'agentic-negotiation', name: 'Agentic Negotiation', description: 'Playbook-driven auto-negotiation with analytics and custom strategies.', tier: 'Competitive Moat', category: 'Trading', status: 'live', path: null, icon: 'Bot', phase: 16, keywords: ['agent', 'playbook', 'auto-negotiate'] },
  { id: 'liquidity-pool', name: 'Institutional Liquidity Pool', description: 'Instant sell to MSI House with AI-driven valuations and speed bonuses.', tier: 'Competitive Moat', category: 'Trading', status: 'live', path: null, icon: 'Droplets', phase: 17, keywords: ['instant', 'sell', 'liquidity', 'house'] },
  { id: 'predictive-alpha', name: 'Predictive Alpha Engine', description: 'Price trajectory forecasting, breakout scoring, and catalyst detection.', tier: 'Competitive Moat', category: 'Analytics', status: 'live', path: null, icon: 'TrendingUp', phase: 18, keywords: ['predict', 'forecast', 'breakout', 'alpha'] },
  { id: 'multi-agent', name: 'Multi-Agent Intelligence', description: 'Four specialized AI agents (Atlas, Apex, Sentinel, Viper) for portfolio analysis.', tier: 'Competitive Moat', category: 'AI', status: 'live', path: null, icon: 'Brain', phase: 19, keywords: ['agent', 'atlas', 'apex', 'sentinel', 'viper'] },
  ...
  { id: 'cross-correlation', name: 'Cross-Asset Correlation', description: 'Hedge strategies across sport ecosystems with diversification scoring.', tier: 'Competitive Moat', category: 'Analytics', status: 'live', path: null, icon: 'GitBranch', phase: 21, keywords: ['correlation', 'hedge', 'diversification'] },
  { id: 'fiscal-intel', name: 'Fiscal Intelligence', description: 'Tax-lot accounting, Schedule D, cost-basis methods, and holding period tracking.', tier: 'Competitive Moat', category: 'Finance', status: 'live', path: null, icon: 'Calculator', phase: 22, keywords: ['tax', 'cost basis', 'schedule d', 'fiscal'] },
  { id: 'visual-audit', name: 'Visual Audit Simulation', description: 'AI grade prediction with sub-grade analysis and grading ROI.', tier: 'Competitive Moat', category: 'AI', status: 'live', path: null, icon: 'ScanEye', phase: 23, keywords: ['grade', 'predict', 'audit', 'sub-grade'] },
  ...
  { id: 'insurance-report', name: 'Insurance Valuation Report', description: 'Insurance-ready valuation documents with replacement cost estimates.', tier: 'Competitive Moat', category: 'Finance', status: 'live', path: null, icon: 'FileCheck', phase: 26, keywords: ['insurance', 'valuation', 'report'] },
  { id: 'what-if', name: 'What-If Simulator', description: 'Test trades before executing and see NAV, ROI, and diversification impact.', tier: 'Competitive Moat', category: 'Analytics', status: 'live', path: null, icon: 'FlaskConical', phase: 27, keywords: ['simulate', 'what if', 'trade', 'test'] },
  { id: 'grading-planner', name: 'Grading Batch Planner', description: 'Optimize grading submissions for maximum ROI with service tier grouping.', tier: 'Competitive Moat', category: 'Tools', status: 'live', path: null, icon: 'ClipboardList', phase: 28, keywords: ['grading', 'batch', 'submission', 'roi'] },
  { id: 'ebay-listing', name: 'eBay Listing Generator', description: 'Auto-generate SEO-optimized eBay listings from card metadata.', tier: 'Competitive Moat', category: 'Trading', status: 'live', path: null, icon: 'ShoppingBag', phase: 29, keywords: ['ebay', 'listing', 'sell', 'seo'] },
  ...
  { id: 'wax-break-roi', name: 'Wax Break ROI Tracker', description: 'Track hobby box break costs vs returns with hit logging.', tier: 'Competitive Moat', category: 'Tools', status: 'live', path: null, icon: 'Package', phase: 31, keywords: ['wax', 'break', 'box', 'roi'] },
  ...
  { id: 'auction-sniper', name: 'Auction Sniper', description: 'Real-time auction monitoring with bid timing optimization.', tier: 'Competitive Moat', category: 'Trading', status: 'live', path: null, icon: 'Crosshair', phase: 34, keywords: ['auction', 'snipe', 'bid', 'timer'] },
  { id: 'consignment', name: 'Consignment Tracker', description: 'Track cards at consignment houses with fee reconciliation.', tier: 'Competitive Moat', category: 'Trading', status: 'live', path: null, icon: 'Truck', phase: 35, keywords: ['consignment', 'pwcc', 'goldin', 'heritage'] },
  ...
  { id: 'anomaly-detection', name: 'Market Anomaly Detection', description: 'Flag unusual price movements and arbitrage opportunities.', tier: 'Competitive Moat', category: 'Analytics', status: 'live', path: null, icon: 'AlertTriangle', phase: 38, keywords: ['anomaly', 'spike', 'crash', 'arbitrage'] },
  ...
  { id: 'live-impact', name: 'Live Game Impact Engine', description: 'Real-time card value shifts during live games with play-by-play impact scoring.', tier: 'Industry-First', category: 'Analytics', status: 'live', path: '/live-impact', icon: 'Radio', phase: 69, keywords: ['live', 'game', 'impact', 'real-time'] },
  { id: 'vision-grading', name: 'AI Vision Grading Lab', description: 'Computer vision card analysis with defect mapping and multi-company grade prediction.', tier: 'Industry-First', category: 'AI', status: 'live', path: null, icon: 'ScanEye', phase: 70, keywords: ['vision', 'grading', 'scan', 'camera', 'defect'] },
  { id: 'fractional-vault', name: 'Fractional Vault & Copy-Trading', description: 'Buy fractional shares of grail cards and copy top collectors\' moves.', tier: 'Industry-First', category: 'Trading', status: 'live', path: '/fractional-vault', icon: 'Landmark', phase: 71, keywords: ['fractional', 'vault', 'shares', 'copy trading'] },
  { id: 'provenance-chain', name: 'Provenance Chain & Digital Twin', description: 'Blockchain-backed provenance with NFT digital twins and QR verification.', tier: 'Industry-First', category: 'Security', status: 'live', path: '/provenance', icon: 'Link2', phase: 72, keywords: ['provenance', 'blockchain', 'nft', 'twin', 'verify'] },
  { id: 'live-breaks', name: 'Live Break Room & Auction AI', description: 'Live break participation with EV analysis and multi-platform auction sniping.', tier: 'Industry-First', category: 'Trading', status: 'live', path: '/live-breaks', icon: 'Tv', phase: 73, keywords: ['break', 'live', 'auction', 'snipe', 'ev'] },
...
export function getCategories(): string[] {
  const cats = new Set(FEATURE_CATALOG.map(f => f.category));
