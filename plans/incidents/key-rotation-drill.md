...
- [ ] Page on-call. Freeze the affected surface if applicable:
      - Stripe: enable Restricted mode for the leaked key.
      - Supabase service role: disable the API in `Project Settings → API`.
      - eBay/Gemini: disable the application in the provider dashboard.
