...
**Last updated:** September 7, 2026 (Consensus View / Comps Used / tax-lot method selector / Auto-Pilot collars; builds on #117–#122)
...
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **Dashboard**                                        | NAV-style hub, widgets, market pulse concepts; league NAV uses sold-comp consensus when comps exist                                                                                                                                                                                                               | Live eBay tape still behind owner-held `VITE_FF_REAL_EBAY`                                                     |
...
| **18 Predictive alpha**        | Modals / engines (prototype); **sold-comp consensus / thin-tape fallback** on valuation apply + Collection/Dashboard display                                                                                | Live injury/transaction feeds                                                 |
...
| Area                                          | Implemented                                                                           | Open / next                                                                       |
| --------------------------------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| **Trading / rules / reports**                 | Trade block concepts, rules engine UI, PDF/exports, benchmarks; Auto-Pilot **daily budget / drawdown / human approval** | Live marketplace execution still out of scope                                      |
