...
**Last updated:** September 7, 2026 (seasonal windows / injury-txn catalysts / Performance vs Price / pop weighting / trade proposals / briefing PDF bars / Auto-Pilot idempotency; builds on #117–#123)
...
| Area                                          | Implemented                                                                           | Open / next                                                                       |
| --------------------------------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| **Trading / rules / reports**                 | Trade block concepts, rules engine UI, PDF/exports, benchmarks; Auto-Pilot **daily budget / drawdown / human approval** + **local idempotency keys**; morning briefing **league-allocation bars** | Live marketplace execution still out of scope                                      |
