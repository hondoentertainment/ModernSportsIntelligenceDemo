...
**Last updated:** September 8, 2026 (Scout-to-Acquire Playwright smoke / thin P2P intent board / `@google/genai` 2.x / adjacent hobby correlation / price-alert haptics / centering heuristic; builds on #117–#125)
...
| ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| **Dashboard**                                        | NAV-style hub, widgets, market pulse concepts; league NAV uses sold-comp consensus when comps exist; **seasonal buy/sell rail**, **holdings injury/txn catalysts**, **MLB Performance vs Price** when stats bind                                                                                                                                                                                                                        | Live eBay tape still behind owner-held `VITE_FF_REAL_EBAY`                                                     |
| **Collection**                                       | Inventory + sold vault, OCR/vision ingest, grading/scarcity UI, virtualized grid, bulk actions, **consignment** modal + **status + Supabase notes codec**, return-to-collection, **stale / thin / source / timestamp / confidence** chips on grid + list + watchlist, **seasonal chips + simulated pop badges**, **advisory trade proposals**, **thin P2P intent board** (local bids/asks), **portfolio stats** helper for header tiles | Optional dedicated DB columns for consignment vs notes; live comps still behind owner-held `VITE_FF_REAL_EBAY` |
| **Watchlist / targets**                              | Targets tab in Collection flow; alerts surfaces; **Vibration API haptics** when a watchlist / price threshold fires (alongside Notification API)                                                                                                                                                                                                                                                                                         | Server-driven push beyond on-device notifications (if product requires)                                        |
| **Deep search / audit**                              | Routes `/deep-search`, `/audit`                                                                                                                                                                                                                                                                                                                                                                                                         | Tighter coupling to live indices where applicable                                                              |
| **MLB / players / teams / games / trends / compare** | Routed pages, data layers (mix of live + simulated). NBA / NFL / NHL hubs now include seeded player + team desks with disclosure.                                                                                                                                                                                                                                                                                                       | Live non-MLB feeds remain unconfigured                                                                         |
| **Auth & profile**                                   | Login, signup, forgot/reset password, demo; Profile + **migration policy** + **duplicate-key preview** (merge vs skip) + last uplink merge line                                                                                                                                                                                                                                                                                         | Tier gates + RLS breadth verification per env                                                                  |
...
| **22 Fiscal**                  | Tax-lot style tooling + **FIFO/LIFO/Specific ID selector** (persisted, demo-safe lot math) + **Schedule D–style export packet** on `/tax-report`                                                            | FIFO/LIFO/specific ID **regulatory completeness** still open                  |
| **23 Visual audit / grading**  | Vision / prediction modals + **disclosed non-CV centering / grade-probability heuristic** on Visual Audit and Centering Analyzer                                                                            | Production CV / PSA-grade model still open                                    |
...
| Area                                          | Implemented                                                                                                                                                                                                           | Open / next                                                                       |
| --------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| **Trading / rules / reports**                 | Trade block concepts, rules engine UI, PDF/exports, benchmarks; Auto-Pilot **daily budget / drawdown / human approval** + **local idempotency keys**; morning briefing **DOM league-allocation bars + HTML download** | Live marketplace execution still out of scope                                     |
...
| Non-MLB hub player/team desks         | **Shipped** (2026-09-06) — NBA / NFL / NHL seeded player + team desks with disclosure. No new Labs pages.                                                                                                                                                                                                                                                                                                                                                                                         |
