...
**Last updated:** September 6, 2026 (pricing truth / Schedule D–style packet / non-MLB hub depth; builds on #117–#121)
...
| **22 Fiscal**                  | Tax-lot style tooling + **Schedule D–style export packet** (ST/LT buckets, totals, methodology disclaimer) on `/tax-report`                                                                                 | FIFO/LIFO/specific ID **regulatory completeness** still open                  |
...
| Sold-comp consensus / pricing truth   | **Shipped** (2026-09-06) — `compConsensus` prefers sold/historical comps on apply + Collection/Dashboard display; thin tape and AI-only paths stay labeled. Flags not flipped.                                                                                                                                                                                                                   |
