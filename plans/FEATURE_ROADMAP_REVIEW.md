...
**Last updated:** September 7, 2026 (seasonal windows / injury-txn catalysts / Performance vs Price / pop weighting / trade proposals / briefing DOM bars + HTML download / Auto-Pilot idempotency; builds on #117–#123)
...
| **Social / hype**                                    | Feed patterns, public portfolio + **iframe embed snippet / widget preview** on Share Alpha and `/p/:username`                                                                                                                                                                                                                                                                              | Full P2P marketplace (roadmap recommendation)                                                                  |
...
| Trade proposal / portfolio delta      | **Shipped (lite)** (2026-09-07) — advisory Card A for Card B + cash from local inventory. Full P2P marketplace still open.                                                                                                                                                                                                                                                                                                                                                                        |
